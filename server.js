...
function bookingConfirmationText(booking) {
  ...
  if (language === "en") {
    return [
      ...
      "- The reinforced aperitif with boards, fried bites and pinse is served until 8:30 pm. After that time, due to the size of the kitchen, the kitchen is dedicated exclusively to restaurant service; the bar continues to serve drinks, but no food for the aperitif area.",
  ...
  return [
    ...
    "- L'aperitivo rinforzato con taglieri, frittini e pinse viene servito fino alle 20.30. Dopo quell'orario la cucina si occupa esclusivamente del servizio ristorante; il bar continua a servire drink, ma non cibo per la zona aperitivo.",
